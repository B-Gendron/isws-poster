...
\begin{tabular}{p{0.35\textwidth} p{0.2\textwidth} p{0.2\textwidth}}
    \begin{minipage}[l]{\linewidth}
        \textbf{Ontology Engineering:}
        \begin{itemize}
            \item Semantic Web basics (RDF, RDFS, OWL).
            \item Learning ontology engineering tools and methodologies, particularly Protégé.
    ...
    \begin{minipage}[r]{\linewidth}
        ...
        \begin{itemize}
            \item Build my own baby language model
