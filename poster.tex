...
\paragraph*{Conceptualization.} Iterative process to gradually complexify the ontology structure and the knowledge it can model. Will to add some linguistic and affective computing notions. Explain our ontology engineering process and how we select and create toy examples.\\
